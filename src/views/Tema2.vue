  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      .col-xl-8.pe-xl-4.d-flex.flex-wrap.align-items-center.order-2.order-xl-1
        .color-primario.p-4.d-flex.flex-wrap(data-aos="fade-right" style="background-color:#FFDBDB")
          .col-md-11.ps-lg-4
            p.mb-0 La empresa como sistema que funciona dentro de un entorno determinado requiere de interacciones con agentes externos que actúan desde diferentes fases del ciclo operativo. Al inicio de este, los proveedores y acreedores suministran los insumos necesarios para el desarrollo del objeto social, y al final, son los clientes quienes demandan la entrega del bien o servicio. La contraprestación recibida por estos últimos posibilita el inicio de un nuevo ciclo que perpetúe la generación de valor. 
              br
              br
              | Del apartado anterior se infiere que los recursos son el medio a través del cual la empresa ejecuta la estrategia para la que fue concebida; en este sentido, la concepción del término “recursos” es tan amplia que alberga elementos de cualquier naturaleza.
      ...
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Recursos humanos
            p Los recursos humanos de una empresa son el conjunto de personas, empleados y colaboradores que forman parte de la organización y contribuyen con sus habilidades, conocimientos y capacidades al funcionamiento y desarrollo de la empresa. La gestión de recursos humanos incluye reclutamiento, selección, capacitación, desarrollo profesional, evaluación del desempeño y todas las actividades destinadas a mantener un ambiente laboral productivo y motivador, promoviendo el bienestar de los empleados y el logro de los objetivos organizacionales.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Recursos materiales
            p Los recursos materiales de una empresa son los elementos físicos y tangibles que la organización utiliza en su proceso productivo o para llevar a cabo sus operaciones comerciales. Estos recursos pueden incluir materias primas, inventario, maquinaria, equipos, mobiliario y cualquier otro bien físico que sea necesario para la producción de bienes o la prestación de servicios.  
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            p Los recursos financieros de una empresa hacen referencia a los fondos, activos y fuentes de capital que la organización posee o tiene acceso. Estos recursos son utilizados para financiar las operaciones, inversiones, pagar deudas, y cubrir gastos en el funcionamiento diario del negocio. Pueden incluir efectivo, cuentas bancarias, inversiones, préstamos, líneas de crédito y cualquier otro medio que facilite el flujo de dinero dentro de la empresa.
